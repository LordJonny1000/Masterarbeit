...
axes[0, 0].set_ylabel('Anzahl Dimensionen', fontsize=12)
axes[0, 0].set_title('Verteilung der VIF-Werte (Embedding-Dimensionen)', fontsize=13)
axes[0, 0].legend()
...
axes[0, 1].set_title('Top 30 Dimensionen mit höchstem VIF', fontsize=13)
...
axes[1, 0].set_title('VIF-Werte für Glasgow Properties', fontsize=13)
...
axes[1, 1].set_title('VIF-Werte über alle Dimensionen', fontsize=13)
axes[1, 1].legend()
